...
if(VCPKG_HOST_IS_LINUX OR VCPKG_TARGET_IS_LINUX OR VCPKG_TARGET_IS_ANDROID)
    vcpkg_from_git(
        ...
        URL git@github.com:adelshokhy112/linux-syscall-support.git
        REF 66889fb86135faeabf06119d5be2fa4ef223a339
    )

    file(RENAME "${LSS_SOURCE_PATH}/lss" "${SOURCE_PATH}/src/third_party/lss")
    file(REMOVE_RECURSE "${LSS_SOURCE_PATH}")
endif()
